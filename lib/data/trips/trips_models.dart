...
class TripDto {
  ...
  factory TripDto.fromJson(Map<String, dynamic> json) {
    return TripDto(
      ...
      finalidade: tripPurposeFromApi(json['finalidade'] as String),
      transporte: tripTransportFromApi(json['transporte'] as String),
  ...
  Trip toDomain() {
    return Trip(id: id, destino: destino, dataIda: dataIda, dataVolta: dataVolta, finalidade: finalidade, transporte: transporte, observacoes: observacoes, status: status, criadoEm: criadoEm);
  }
}

class TripCreateRequest {
  TripCreateRequest({required this.destino, required this.dataIda, required this.dataVolta, required this.finalidade, required this.transporte, this.observacoes});
  ...
  factory TripCreateRequest.fromInput(TripCreateInput input) {
    return TripCreateRequest(destino: input.destino, dataIda: input.dataIda, dataVolta: input.dataVolta, finalidade: input.finalidade, transporte: input.transporte, observacoes: input.observacoes);
  }

  Map<String, dynamic> toJson() {
    return {
      'destino': destino,
      'dataIda': formatDate(dataIda),
      'dataVolta': formatDate(dataVolta),
      'finalidade': tripPurposeToApi(finalidade),
      'transporte': tripTransportToApi(transporte),
